      ...
      <Tabs defaultValue="overview" className="w-full space-y-6">
        ...
        <TabsContent value="pagamentos" className="space-y-6 mt-0">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <Card className={`shadow-sm relative overflow-hidden group hover:shadow-md transition duration-200 ${
              caixaLiquidoReal >= 0 ? "border-emerald-500/10" : "border-rose-500/10"
            }`}>
              <div className={`absolute top-0 left-0 w-full h-1 ${
                caixaLiquidoReal >= 0 ? "bg-emerald-500" : "bg-rose-500"
              }`} />
              <CardContent className="flex items-center gap-4 p-5">
                ...
                <div className="space-y-1">
                  ...
                  <div className={`text-2xl font-bold ${
                    ...
                    {brl(caixaLiquidoReal)}
                  </div>
                  <div className="text-[11px] text-muted-foreground">
                    Previsto: <span className="font-semibold">{brl(caixaLiquidoPrevisto)}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-border shadow-sm relative overflow-hidden group hover:shadow-md transition duration-200">
              ...
              <CardContent className="flex items-center gap-4 p-5">
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-[11px] text-muted-foreground">
                    A receber: <span className="font-medium">{brl(stats.faturamentoPendente)}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-border shadow-sm relative overflow-hidden group hover:shadow-md transition duration-200">
              ...
              <CardContent className="flex items-center gap-4 p-5">
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-[11px] text-muted-foreground">
                    Apto: <span className="text-emerald-600 dark:text-emerald-400 font-semibold">{brl(repasseStats.repasseApto)}</span> | Bloq: <span className="text-rose-500 font-semibold">{brl(repasseStats.repasseBloqueado)}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
